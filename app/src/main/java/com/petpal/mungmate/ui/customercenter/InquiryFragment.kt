...
class InquiryFragment : Fragment() {
    ...
    private fun getSampleData(): List<Inquiry> {
        return listOf(
            Inquiry("포인트", "포인트가 누락됐어요", "어제 산책 다 끝냈는데 포인트가 안들어왔어요ㅠㅠ", "100 포인트 적립 도와드렸습니다. 이용에 불편을 드려서 죄송합니다.", "aaa", "2023.09.10", false),
            Inquiry("포인트", "포인트가 누락됐어요", "어제 산책 다 끝냈는데 포인트가 안들어왔어요ㅠㅠ", "100 포인트 적립 도와드렸습니다. 이용에 불편을 드려서 죄송합니다.", "aaa", "2023.09.10", true)
        )
